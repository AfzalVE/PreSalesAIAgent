...
class AgentExtractionResponse(BaseModel):
    ...
    mvp_timeline_weeks: Optional[int] = Field(None, description="The estimated timeline for the MVP in weeks.")
    full_timeline_weeks: Optional[int] = Field(None, description="The estimated timeline for the Full Product in weeks.")
    ...
    # State flags
    workflow_state: Optional[WorkflowState] = Field(None, description="The current deterministic state of the conversation.")
