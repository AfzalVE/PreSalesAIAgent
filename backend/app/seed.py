...
def seed_data():
    ...
    try:
        ...
        prop_2_mvp = Proposal(
            ...
            request_id=req_2.id,
            proposal_type=ProposalType.MVP,
            tech_stack={"backend": "Python", "llm": "OpenAI gpt-4.1", "db": "Qdrant"},
        ...
        prop_2_full = Proposal(
            ...
            request_id=req_2.id,
            proposal_type=ProposalType.FULL,
            tech_stack={"backend": "FastAPI", "frontend": "React", "llm": "OpenAI gpt-4.1", "vector_db": "Qdrant", "queue": "Celery & Redis"},
