...
def get_dashboard_stats_service(db: Session) -> Dict[str, Any]:
    """
    Computes comprehensive executive dashboard metrics and dynamic chart distributions
    directly from active database rows.
    """
...
def get_otp_logs_service(db: Session) -> List[Dict[str, Any]]:
    """
    Retrieves and formats OTP verification logs from the database.
    """
